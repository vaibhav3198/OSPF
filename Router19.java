...
public class Router19
{
    ...
    Router19() throws SocketException, UnknownHostException {
        Initialise();
    ...
    {
        this.address = new Address(InetAddress.getByName("localhost"),1111);
        this.socket = new DatagramSocket(this.address.port);   //takes current ip by default

        //setting neighbours
        neighbours = new ArrayList<>();
        Neighbour temp1 = new Neighbour(InetAddress.getByName("localhost"),2222,5);
        Neighbour temp2 = new Neighbour(InetAddress.getByName("localhost"),3333,10);
    ...
    public static void main(String[] args) throws SocketException, UnknownHostException {
        Router19 router19 = new Router19();
//        for(int i=0;i<2;i++)
//        {
//            router19.Receive();
//        }
        ...
        LSP2 test = new LSP2(router19.address.ipAddr,router19.address.port,1,16,router19.neighbours);

        for(int i=0;i<2;i++)
        {
            router19.Send(new Address(InetAddress.getByName("localhost"),1919),test);
        }
    }
}
